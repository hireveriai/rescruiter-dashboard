...
export async function openWarRoom(orgIdOverride) {
  ...
  const hireveriSession =
    typeof session?.hireveriSession === "string" && session.hireveriSession.trim()
      ? session.hireveriSession.trim()
      : null;
