...
export default function DockItem({
  ...
  const content = (
    <motion.span
      className={[
        "group relative flex h-12 w-12 items-center justify-center rounded-2xl border transition-colors duration-200 md:h-[52px] md:w-[52px]",
        active
    ...
    >
      ...
      <Icon
        ...
        strokeWidth={1.8}
        className={[
          "h-[21px] w-[21px] transition duration-200",
