        ...
        <div className="mx-auto flex w-full max-w-[1840px] flex-nowrap items-center justify-between gap-3 px-3 py-4 sm:px-4 xl:px-6">
          ...
          <div className="flex shrink-0 flex-nowrap items-center gap-2">
            ...
            <button
              ...
              className="whitespace-nowrap rounded-xl border border-blue-400/40 bg-transparent px-3 py-2 text-xs font-medium text-blue-300 transition hover:border-blue-300 hover:bg-blue-500/10 hover:text-white xl:px-4 xl:py-2.5 xl:text-sm"
            >
              Send Interview Link
            </button>
